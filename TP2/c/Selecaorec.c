...
// Função recursiva para o Selection Sort
void recursiveSelectionSort(Pokemon *array, int n, int index) {
    if (index == n) return;
    ...
    recursiveSelectionSort(array, n, index + 1);
}
...
int main() {
    ...
    recursiveSelectionSort(selectedPokemons, selectedCount, 0);
    ...
    char logFileName[50];
    sprintf(logFileName, "%s_selecaoRecursiva.txt", matricula);

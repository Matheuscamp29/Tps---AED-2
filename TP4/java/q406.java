...
public class q406 {
    ...
    public static void main(String[] args) {
        ...
        HashRehash hash = new HashRehash(21);
...
class HashRehash {
    ...
    public boolean inserir(String nome) {
        ...
        if (tabela[pos] == null) {
            ...
            int posRehash = reh(nome);
            if (tabela[posRehash] == null) {
                tabela[posRehash] = nome;
                return true;
            } else {
                return false;
            }
    ...
    public int pesquisar(String nome, Comparacao comparacaoObj) {
        ...
        if (nome.equals(tabela[pos])) {
            ...
            int posRehash = reh(nome);
            comparacaoObj.incrementar(); // Comparação com a posição de rehash
            if (nome.equals(tabela[posRehash])) {
                return posRehash;
            }
        }
